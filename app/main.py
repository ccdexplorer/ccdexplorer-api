...
from app.routers import contract_v1
from app.routers import misc_v1
from app.routers import user_v1
...
app.include_router(contract_v1.router)
app.include_router(misc_v1.router)
